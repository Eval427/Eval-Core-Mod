...
#Some of these are from ECK. Massive thanks to him
...
image evalsmokeoverlay = "bg/evalsmokeoverlay.png"
image evalsmokeoverlayflip = im.Flip("bg/evalsmokeoverlay.png", horizontal=True)
image evalhospitalroom = "bg/evalhospitalroom.png"
image evalhospitalroomnight = "bg/evalhospitalroomnight.png"
image evalhospitalhall = "bg/evalhospitalhall.png"
...
image remy angry eval shot = "cr/remy_angry_eval_shot.png"
...
#Note: There are more expressions than what is listed here. They are programatically incorporated into the game in __init__.py